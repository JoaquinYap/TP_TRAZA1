...
public class Main {
    public static void main(String[] args) {
        ...
        //La Sucursal sabe para que empresa trabaja
        empresa1.getSucursales().forEach(s -> s.setEmpresa(empresa1));
        empresa2.getSucursales().forEach(s -> s.setEmpresa(empresa2));
